...
65 advisors | 29 profiled | 36 unprofiled
...
| Advisor | Expertise |
|---------|-----------|
| **Andy Raskin** | Evaluates narrative structure — opens with a shift in the world, compelling arc, stakes |
| **April Dunford** | Evaluates positioning clarity, differentiation, competitive alternatives, "why now" |
| **Elon Musk** | Questions inherited assumptions, first-principles thinking, 10x simplification |
| **Eric Ries** | Evaluates assumption validation, testable hypotheses, MVP scoping |
| **Garry Tan** | Evaluates founder earnestness, AI-native product design, user connection |
| **Jeff Bezos** | Evaluates customer impact, long-term thinking, reversibility, scalability |
| **Jim Dethmer** | Evaluates leadership integrity — radical responsibility, candor, agreements |
| **Joanna Wiebe** | Evaluates conversion copy — Seven Sweeps, headlines, CTAs, voice-of-customer |
| **Joe Pulizzi** | Evaluates content strategy — audience-first lens, content tilt, subscriber relationships |
| **Lara Hogan** | Evaluates leadership transitions — level-specific competencies, BICEPS needs |
| **Oli Gardner** | Evaluates conversion-centered design — attention ratio, page focus, structural hierarchy |
| **Patrick Campbell** | Evaluates pricing, packaging, value metrics, churn, retention mechanics |
| **Paul Graham** | Evaluates whether founders build something people want — idea validation, growth |
| **Ram Charan** | Evaluates leadership behavior against passage requirements — skills, time, values |
| **Ray Dalio** | Evaluates cause-effect systems, feedback loops, second-order consequences |
| **Richard Rumelt** | Evaluates strategic coherence — identifying the crux, cutting fluff, focus |
| **Rob Walling** | Evaluates bootstrapped SaaS viability — channels, pricing, PMF stage |
| **Robb Wolf** | Evaluates health product content — scientific defensibility, evidence tiers |
| **Robbie Kellman Baxter** | Evaluates membership thinking — forever promise, ongoing value, retention |
| **SEO Expert** | Evaluates search performance — keywords, meta descriptions, heading hierarchy |
| **Shirin Oreizy** | Evaluates behavioral science — cognitive load, friction, Homer vs Spock |
| **Steve Jobs** | Evaluates simplicity and focus — every element earns its place |
| **Steve Krug** | Evaluates usability — Trunk Test, question marks, scanning, conventions |
| **The Architect** | Evaluates codebase alignment, patterns, module boundaries, integration risk |
| **The Designer** | Evaluates visual craft — hierarchy, spacing, typography, design system compliance |
| **The DevEx Engineer** | Evaluates developer experience — maintainability, ergonomics, tooling |
| **The PM** | Evaluates product value — user problems, scope control, success criteria |
| **The QA Engineer** | Evaluates failure modes — edge cases, error paths, reliability |
| **The Security Reviewer** | Evaluates security surface — auth, injection, data exposure, OWASP top 10 |

## Unprofiled Advisors

These advisors have prompts but have not yet been profiled with evaluation expertise.
