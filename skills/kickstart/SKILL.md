...
**Run a brainstorm.** Try `/aligned:brainstorming` with a real problem you're working on. The router auto-routes across four modes (software, authoring, research, roadmap) and selects relevant advisors for the critique panel.
