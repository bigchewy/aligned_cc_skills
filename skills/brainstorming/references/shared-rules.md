...
This rule applies to the four modes that produce a live HTML artifact: software, business, authoring, and roadmap. Research mode does not generate a live artifact and skips this rule.
