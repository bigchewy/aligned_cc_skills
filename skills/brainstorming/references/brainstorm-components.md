...
Each visualizing mode owns its own HTML template file. The four templates start as byte-identical copies; they are independent files going forward, free to diverge as the modes' visual needs differ.
