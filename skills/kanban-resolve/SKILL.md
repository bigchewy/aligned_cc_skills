---
name: kanban-resolve
description: Use when the Kanban board has accumulated items in docs/kanban/todo/ and you want to triage and resolve them all in a single automated pass.
---
