...
- **Location:** `e2e/tests/test_halt_protocol.py:67-72` (`test_format_halt_echoes_canonical_fix` parametrize) and `scripts/autopilot/lib/halt.sh:110-136` (the `headless_auth_incompat` heredoc)
