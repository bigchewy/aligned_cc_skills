...
A virtual board of advisors for Claude Code. 59 expert personas, 115 structured frameworks, auto-selected by context.
...
4. **Try a framework.** `/aligned:use-framework` to browse 115 structured decision frameworks with interactive, phase-gated walkthroughs.
## Reference
...
59 advisor prompts ship with the plugin in `advisors/prompts/`.
