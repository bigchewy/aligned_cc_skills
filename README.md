...
A virtual board of advisors for Claude Code. 70 expert personas, 148 structured frameworks, auto-selected by context.
...
4. **Try a framework.** `/aligned:use-framework` to browse 148 structured decision frameworks with interactive, phase-gated walkthroughs.
## Reference
